...
- Si vas a tocar diseño, layouts, componentes visuales o shadcn → leé `design.md`, `marz-docs/DESIGN-DEV.md` y el `design-handoff.md` de la feature (reglas de lectura del `.pen` con Pencil CLI — read-only para devs).
