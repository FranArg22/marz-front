...
function makeCard(params: {
  ...
  return {
    ...
    campaign: {
      ...
      target_url: 'https://brand.example.com/campaign',
      image_url: 'https://cdn.test/campaign-board.jpg',
...
function makeDetailResponse(card: CreatorCampaignBoardCard) {
  return {
    ...
    brief: {
      content_guidelines:
        'Mostrá el producto en uso real, con tu estilo y sin guion rígido.',
      brief_pdf_url: 'https://cdn.test/brief.pdf',
    },
    targeting: {
      platforms: card.targeting.platforms,
      interests: card.targeting.interests,
      creator_country: 'AR',
    ...
    commercial: {
      ...
      compensation_notes: 'Pago fijo por deliverable aprobado.',
