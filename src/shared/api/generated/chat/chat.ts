...
export type listConversationsResponseError = (
  ...
  | listConversationsResponse409
  | listConversationsResponse422
...
export const getListConversationsUrl = (params?: ListConversationsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/v1/conversations?${stringifiedParams}`
    : `/v1/conversations`
}
...
export const listConversations = async (
  ...
  return customFetch<listConversationsResponse>(
...
export const getListConversationsQueryKey = (
  ...
  return [`/v1/conversations`, ...(params ? [params] : [])] as const
}
...
export const getConversation = async (
  ...
  return customFetch<getConversationResponse>(
...
export const getGetConversationQueryKey = (conversationId: string) => {
  return [`/v1/conversations/${conversationId}`] as const
}
...
export type sendMessageResponseError = (
  ...
  | sendMessageResponse403
  | sendMessageResponse404
  | sendMessageResponse409
...
export const useSendMessage = <TError = Error, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof sendMessage>>,
      TError,
...
export type listMessagesResponseError = (
  | listMessagesResponse401
  | listMessagesResponse403
  | listMessagesResponse404
  | listMessagesResponse422
...
export const getListMessagesUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/v1/conversations/${conversationId}/messages?${stringifiedParams}`
...
export const useMarkRead = <TError = Error, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof markRead>>,
      TError,
